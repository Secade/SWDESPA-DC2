...
public class UserWithSongService {
    ...
    public List<UserWithSong> getAll(){
        ...
        String query = "SELECT * FROM " + UserWithSong.TABLE_NAME
                    +"WHERE " +UserWithSong.COL_USERID+ "=" + loggedin.getId() ;
    ...
    private Song getMostPlayed(){
        ...
        String query = "SELECT " +Song.TABLE_NAME + "." + Song.COL_SONGID +","+ Song.TABLE_NAME + "." + Song.COL_SONGTITLE +","+Song.TABLE_NAME + "." + Song.COL_GENRE+","+ Song.TABLE_NAME + "." + Song.COL_ALBUM +","+ Song.TABLE_NAME + "." + Song.COL_ARTIST+","+ Song.TABLE_NAME + "." + Song.COL_YEAR+","+ Song.TABLE_NAME + "." + Song.COL_DURATION+","+ Song.TABLE_NAME + "." + Song.COL_FILENAME+
                        ...
                        "WHERE " +UserWithSong.TABLE_NAME+"."+UserWithSong.COL_USERID +"="+ loggedin.getId() +"AND " +UserWithSong.TABLE_NAME+"."+UserWithSong.COL_PLAYCOUNT+"="+
                        "(SELECT MAX(" +UserWithSong.TABLE_NAME+"."+UserWithSong.COL_PLAYCOUNT+ ") FROM " +UserWithSong.TABLE_NAME + "WHERE "+ UserWithSong.COL_USERID +"="+ loggedin.getId()+")";
